...
/* ============================================
   ILS — Light / Dark Theme Toggle
   Persists choice in localStorage. The saved
   theme is applied pre-paint by a small inline
   script in each page's <head> (no flash).
   Dark theme is deep navy — never pure black.
   ============================================ */

(function () {
  var STORAGE_KEY = 'ils-theme';
