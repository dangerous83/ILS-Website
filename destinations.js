...
(function () {
  const DESTINATIONS = {
    'middle-east': {
      ...
      heroImage: '../asset/Dubai.png?v=20260629d',
    ...
    'central-asia': {
      ...
      heroImage: '../asset/Astana.png?v=20260629d',
    ...
    'south-asia': {
      ...
      heroImage: '../asset/Karachi.png?v=20260629d',
    ...
    'europe': {
      ...
      region: 'Europe',
      breadcrumb: 'Europe',
      heroImage: '../asset/Hamburg.png?v=20260629d',
