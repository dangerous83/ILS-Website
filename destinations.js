...
(function () {
  const DESTINATIONS = {
    'middle-east': {
      num: '01',
      region: 'Saudi Arabia',
      breadcrumb: 'Saudi Arabia',
      heroImage: '../asset/Saudi Arabia 22.webp?v=20260709',
      heroTitleHTML: 'Shipping to <span class="accent">Saudi Arabia</span>',
      heroSubtitle: 'Our Dubai hub connects the Gulf to the Kingdom’s key gateways — Jeddah, Riyadh, and Dammam — with daily air, sea, and road consolidations and on-the-ground customs expertise across Saudi Arabia.',
      eyebrow: 'Saudi Arabia Gateway',
      detailTitleHTML: 'A trusted partner for <span class="accent">Saudi trade</span>',
      detailDesc: "From Dubai's Jebel Ali and DXB, our Saudi Arabia desk consolidates daily air, sea, and road shipments into Jeddah, Riyadh, and Dammam. Bonded warehouses, free-zone expertise, and Arabic-speaking customs brokers handle SABER, SASO, and Fasah clearance end to end.",
      modes: { air: true, road: true, sea: true },
      features: [
        'Daily air &amp; sea consolidations from the Dubai hub',
        'FCL &amp; LCL ocean to Jeddah, Dammam &amp; King Abdullah Port',
        'Cross-border trucking into Riyadh, Jeddah &amp; Dammam',
        'SABER, SASO &amp; Fasah customs clearance across the Kingdom',
        'Bonded &amp; free-zone warehousing in the UAE',
      ],
      lanes: [
        { mode: 'air',  route: 'Dubai (DXB) → Riyadh (RUH)',     transit: 'Air freight transit: <strong>2 hours</strong> · Daily departures' },
        { mode: 'sea',  route: 'Jebel Ali → Jeddah (JED)',       transit: 'FCL ocean transit: <strong>4–6 days</strong> · Multiple sailings/week' },
        { mode: 'road', route: 'Dubai → Riyadh',                 transit: 'Cross-border road: <strong>2–3 days</strong> · Daily trucks' },
        { mode: 'air',  route: 'Dubai (DXB) → Jeddah (JED)',     transit: 'Air freight transit: <strong>2.5 hours</strong> · Daily flights' },
        { mode: 'sea',  route: 'Shanghai → Dammam (DMM)',        transit: 'FCL ocean transit: <strong>18–22 days</strong> · Weekly sailings' },
        { mode: 'road', route: 'Dubai → Dammam',                 transit: 'Cross-border road: <strong>1 day</strong> · Daily trucks' },
      ],
    },
    ...
    'central-asia': {
      ...
      detailDesc: 'Our SILKWAY operation links Europe, the Middle East, and China to the Central Asian republics with reliable road, rail, and air services — handling customs in English and local languages.',
      ...
      features: [
        ...
        'Road transit via Turkey and the CIS',
        'Air consolidations from Dubai and Istanbul',
        'Customs brokerage in local-language markets',
      ],
      lanes: [
        ...
        { mode: 'road', route: 'Poti → Ashgabat',             transit: 'Trans-Caspian road: <strong>7–9 days</strong> · 2x weekly' },
